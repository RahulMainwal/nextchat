...
<div className="h-screen md:flex">
                <div
                    ...
                    <div>
                        ...
                        {/* <p className="text-white mt-1">This is a login page</p> */}
                ...
                <div className="flex flex flex-col h-screen md:w-1/2 justify-center py-10 items-center bg-white">
      ...
      <Link href={"/"} className="text-sm ml-2 hover:text-blue-500 cursor-pointer">Forgot Password ?</Link> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <Link href={"/register"} className="text-sm ml-2 hover:text-blue-500 cursor-pointer">Sign Up</Link>
    </form>
                </div>
            </div>
    </div>
