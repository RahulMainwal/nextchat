        ...
        <div>
            <div className="h-screen md:flex">
                <div
                    ...
                    <div>
                        <h1 className="text-white font-bold text-4xl font-sans">Welcome! to Registration Page</h1>
                ...
                <div className="flex flex flex-col h-screen md:w-1/2 justify-center py-10 items-center bg-white">
                    <form className="bg-white">
                       ...
                       <Link href={"/login"} className="text-sm ml-2 hover:text-blue-500 cursor-pointer">Already Account</Link>
                    </form>
                </div>
            </div>
        </div>
